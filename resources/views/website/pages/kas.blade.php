    ...
    <form id="quickForm" action="{{ route('website.kas.simpan') }}" method="post">
      <div class="card-body">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <select class="form-control select2" style="width: 100%;" name="nama_akun" id="nama_akun">
            </select>
            @error('nama_akun')
            <span class="text-danger">{{ $message }}</span>
            @enderror
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="number" class="form-control form-control" id="jumlah" name="jumlah" placeholder="Masukkan Jumlah">
            @error('jumlah')
            <span class="text-danger">{{ $message }}</span>
            @enderror
          </div>
